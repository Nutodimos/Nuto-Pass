    ...
    return (
        <div className="flex-1 p-6 flex flex-col gap-6 xl:flex-row bg-[#F7F8FA] min-h-full">
            ...
            <div className="w-full xl:w-2/3 flex flex-col gap-6">
                ...
                {/* --- HERO HEADER CARD --- */}
                <div className="nuto-card relative bg-white p-6 md:p-8 flex flex-col md:flex-row gap-6 md:gap-8 items-center md:items-start group z-10 w-full min-h-max">
                    {/* Fancy background gradients - contained in their own layer so they don't clip the card content */}
                    <div className="absolute inset-0 rounded-2xl overflow-hidden pointer-events-none z-0">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-nutoOrange/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3"></div>
                        <div className="absolute bottom-0 left-0 w-64 h-64 bg-nutoSlate/5 rounded-full blur-3xl translate-y-1/3 -translate-x-1/3"></div>
                    </div>
                    <div className="nuto-card-indicator z-20" />

                    {/* Lesson Icon/Image */}
                    <div className="relative w-28 h-28 shrink-0 rounded-2xl bg-gradient-to-br from-nutoSlate to-slate-800 p-[3px] shadow-lg z-10">
                        <div className="w-full h-full bg-white rounded-xl flex items-center justify-center overflow-hidden relative">
                            <BookOpen className="w-12 h-12 text-nutoSlate absolute opacity-10" />
                            <div className="flex flex-col items-center z-10">
                                <span className="text-4xl font-black text-nutoSlate leading-none">{lesson.subject.name.substring(0, 1).toUpperCase()}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex-1 flex flex-col justify-center items-center md:items-start text-center md:text-left z-10 relative w-full">
                        ...
                        <div className="flex w-full items-center justify-between mb-3">
                            <span className="px-3 py-1 bg-gradient-to-r from-nutoOrange to-nutoOrangeDark text-white text-xs font-bold uppercase tracking-wider rounded-full shadow-sm whitespace-nowrap">
                                {lesson.day}
                            </span>
                            {role === "admin" && (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="nuto-card flex-col md:flex-row p-5 flex items-center md:items-center justify-center md:justify-start gap-4 group">
                        ...
                        <div className="nuto-card-indicator bg-gradient-to-r from-blue-500 to-blue-400" />
                    </div>

                    <div className="nuto-card flex-col md:flex-row p-5 flex items-center md:items-center justify-center md:justify-start gap-4 group">
                        <div className="w-12 h-12 rounded-full bg-nutoOrange/10 text-nutoOrange flex items-center justify-center group-hover:scale-110 transition-transform shrink-0">
                        ...
                        <div className="nuto-card-indicator bg-gradient-to-r from-nutoOrange to-nutoOrangeDark" />
                    </div>
                ...
                {(role === "admin" || (role === "teacher" && lesson.teacherId === currentUserId)) && (
                    <div className="nuto-card p-6 md:p-8 flex flex-col gap-6 w-full">
                        ...
                        <div className="nuto-card-indicator z-0" />
                    </div>
                )}
            </div>
            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-6">
                ...
                {/* --- QUICK LINKS CARD --- */}
                <div className="nuto-card p-6 border-l-4 border-l-nutoOrange">
                    <h3 className="font-bold text-lg text-slate-800 mb-4 flex items-center gap-2">
                        <Calendar className="w-5 h-5 text-nutoOrange" />
                        Quick Links
                    </h3>
                    ...
                    <div className="nuto-card-indicator" />
                </div>
                ...
                {/* Help/Support Card */}
                <div className="nuto-card p-6 bg-gradient-to-br from-slate-800 to-nutoSlate text-white border-0 mt-auto shadow-lg shadow-nutoSlate/20">
                    ...
                    <Link href="/contact" className="inline-block w-full text-center px-4 py-3 bg-white hover:bg-slate-100 text-nutoSlate rounded-xl text-sm font-bold shadow-sm transition-all active:scale-95">
                        Contact Support
                    </Link>
                </div>
            </div>
